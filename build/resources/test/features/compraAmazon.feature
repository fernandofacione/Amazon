#language: pt
Funcionalidade: Compra Produto Amazon
  Cenario: Pesquisar Curso com Clique e Incluir no Carrinho
    ...
    Entao confirmo o nome do produto como "Cafeteira Expresso Prima Latte II, Vermelho, 110v, Oster" e o preco de "R$ 1199.00"
